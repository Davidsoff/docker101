defmodule MultiContainerApplication.AccountsTest do
  use MultiContainerApplication.DataCase

  alias MultiContainerApplication.Accounts
  alias MultiContainerApplication.Accounts.User
