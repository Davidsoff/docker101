...
# MultiContainerApplication.Web.Endpoint.load_from_system_env/1 dynamically.
...
# start per endpoint:
#
#     config :multi_container_application, MultiContainerApplication.Web.Endpoint, server: true
#
